...
def encoder_args(parser):
    ...
    parser.add_argument("--bert_name", default='ptm/roberta-large-wwm-chinese-cluecorpussmall', type=str, help='bert模型存放的目录')
    parser.add_argument("--bert_hidden_size", default=1024, type=int,
...
def target_args(parser):
    ...
    parser.add_argument("--target", default='linear', type=str, help="从向量到输出结果之间的网络.")
    return parser
