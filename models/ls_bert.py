...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained("../ptm/bert-base-uncased")

    print("creating huggingface model...")
    hf_model = BertForSequenceClassification.from_pretrained("../ptm/bert-base-uncased")
    hf_model.to("cuda:0")

    print("creating lightseq model...")
    ls_model = LightseqBertClassification("../ptm/lightseq_bert_base_uncased.hdf5", hf_model)
